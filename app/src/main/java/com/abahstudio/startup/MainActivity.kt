...
//        lsListSongs.adapter=adapter
    ...
    fun LoadURLOnline(){
        listSongs.add(SongInfo("AlFatihah","Ahmed","http://server6.mp3quran.net/hamad/001.mp3"))
        listSongs.add(SongInfo("AlFatihah","Al Ghamidi","http://server6.mp3quran.net/ghamdi/001.mp3"))
        listSongs.add(SongInfo("AlBaqarah","Ahmed","http://server6.mp3quran.net/hamad/002.mp3"))
    }
